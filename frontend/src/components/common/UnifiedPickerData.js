...
export const EMOJI_DATA = {
  smileys: {
    ...
    emojis: [
      ...
      { emoji: '🥲', keywords: ['smiling tear', 'grateful', 'touched'] },
      ...
      { emoji: '🫡', keywords: ['salute', 'respect', 'yes sir'] },
      ...
      { emoji: '🫠', keywords: ['melting', 'sarcasm', 'hot'] },
      ...
      { emoji: '😮‍💨', keywords: ['exhale', 'relief', 'sigh'] },
      { emoji: '🤥', keywords: ['liar', 'pinocchio', 'lying'] },
      { emoji: '🫣', keywords: ['peeking', 'shy', 'nervous'] },
      ...
      { emoji: '🥸', keywords: ['disguise', 'nose glasses', 'incognito'] },
      ...
      { emoji: '🫤', keywords: ['diagonal mouth', 'meh', 'unsure'] },
  ...
  people: {
    ...
    emojis: [
      ...
      { emoji: '🫱', keywords: ['rightward hand', 'point'] },
      { emoji: '🫲', keywords: ['leftward hand', 'point'] },
      ...
      { emoji: '🫰', keywords: ['hand with index and thumb crossed', 'money'] },
      ...
      { emoji: '🫵', keywords: ['pointing at viewer', 'you'] },
      ...
      { emoji: '🫶', keywords: ['heart hands', 'love', 'affection'] },
  ...
  animals: {
    ...
    emojis: [
      ...
      { emoji: '🐈‍⬛', keywords: ['black cat', 'halloween'] },
      ...
      { emoji: '🫏', keywords: ['donkey', 'mule', 'stubborn'] },
      ...
      { emoji: '🦣', keywords: ['mammoth', 'ice age', 'extinct'] },
      ...
      { emoji: '🐻‍❄️', keywords: ['polar bear', 'arctic', 'white'] },
      ...
      { emoji: '🦫', keywords: ['beaver', 'dam', 'build'] },
  ...
  nature: {
    ...
    emojis: [
      ...
      { emoji: '🪻', keywords: ['hyacinth', 'flower', 'lavender'] },
      { emoji: '🪷', keywords: ['lotus', 'meditation', 'zen'] },
      ...
      { emoji: '🪹', keywords: ['empty nest', 'bird'] },
  ...
  travel: {
    ...
    emojis: [
      ...
      { emoji: '🛻', keywords: ['pickup truck', 'truck'] },
  ...
  objects: {
    ...
    emojis: [
      ...
      { emoji: '🪫', keywords: ['low battery', 'charge'] },
      ...
      { emoji: '🪪', keywords: ['id card', 'identification'] },
    ],
  },
  symbols: {
    label: '🔣 Symbols',
